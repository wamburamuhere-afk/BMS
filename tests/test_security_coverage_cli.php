...
$CEILINGS = [
    ...
    'view_pages_no_log'   => 54,    // Phase 7 (DEFERRED). Dropped 59→49 by Phase 3. Raised 49→54 for CRM Phase 1-6 view pages (crm_leads, crm_pipeline, crm_pipeline_stages, crm_lead_view, crm_dashboard — display-only pages).
