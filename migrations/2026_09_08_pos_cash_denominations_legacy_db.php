 ...
 *
 * Mirrors migrations/tenant/2026_09_08_pos_cash_denominations.php (Phase 20
...
echo "Starting migration: POS cash denominations on the legacy database (Phase 20)...\n";
