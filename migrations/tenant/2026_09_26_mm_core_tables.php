<?php
/**
 * migrations/tenant/2026_09_26_mm_core_tables.php
 *
 * Phase 0 — Mobile Money module: core tables.
 * Creates: mm_networks, mm_agents, mm_tills, mm_commission_rates, mm_transactions
 * All tables: InnoDB, utf8mb4_unicode_ci, append-only (no DELETE on mm_transactions).
...
echo "Starting tenant migration: mm_core_tables...\n";
...
try {
    ...
    echo "Migration complete: mm_core_tables.\n";
