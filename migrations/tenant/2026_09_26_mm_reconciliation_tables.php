<?php
/**
 * migrations/tenant/2026_09_26_mm_reconciliation_tables.php
 *
 * Phase 0 — Mobile Money module: reconciliation tables.
 * Creates: mm_reconciliations, mm_recon_items
 */
...
echo "Starting tenant migration: mm_reconciliation_tables...\n";
...
try {
    ...
    echo "Migration complete: mm_reconciliation_tables.\n";
