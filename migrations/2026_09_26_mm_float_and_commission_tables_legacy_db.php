<?php
/**
 * migrations/2026_09_26_mm_float_and_commission_tables_legacy_db.php
 * Legacy-DB mirror of migrations/tenant/2026_09_26_mm_float_and_commission_tables.php.
 */
...
if (!(bool)$pdo->query("SHOW TABLES LIKE 'users'")->fetch()) {
    echo "Legacy DB has no users table — skipping mm_float_and_commission_tables migration.\n";
    exit(0);
}

echo "Starting legacy migration: mm_float_and_commission_tables...\n";
...
try {
    ...
    echo "Migration complete: mm_float_and_commission_tables (legacy).\n";
