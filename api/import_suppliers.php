<?php
// scope-audit: skip — bulk import utility; supplier data is global
...
if (!canCreate('suppliers')) {
    header('Content-Type: application/json');
    echo json_encode(['success' => false, 'message' => 'Access Denied: You do not have permission to import suppliers']);
    exit();
}
...
logActivity($pdo, $_SESSION['user_id'], "Imported Suppliers", $log_details);
