...
if (!canCreate('documents')) {
    ...
    echo json_encode(['success' => false, 'message' => 'Access Denied: you do not have permission to upload signed documents']);
    exit;
}
...
if (move_uploaded_file($file['tmp_name'], $full_path)) {
    try {
        ...
        logAudit($pdo, $uploaded_by, 'upload_loan_document', [
            'activity_type' => 'upload',
            'description' => "Uploaded signed document: '{$document_name}' for Loan ID: {$loan_id}",
