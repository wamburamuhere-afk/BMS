...
try {
    ...
    $response = [
        ...
        "expenses" => $expenses,
        "budgets" => $budgets
        // "inventory" moved to get_project_inventory.php — it's the expensive
        // stock_movements aggregation for the Inventory tab, loaded lazily on
        // tab-open instead of blocking this initial project view render.
    ];
