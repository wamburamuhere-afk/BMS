...
try {
    ...
    if (!empty($id) ? !canEdit('lead_generation') : !canCreate('lead_generation')) {
        http_response_code(403);
        throw new Exception('Access Denied: you do not have permission to ' . (!empty($id) ? 'edit' : 'create') . ' leads');
    }
