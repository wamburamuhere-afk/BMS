...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .box { width: 50%; background: #f4f6fb; padding: 14px 16px; border-radius: 6px; border-left: 4px solid #0f1f3d; print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        .box h3 { font-size: 11px; color: #0f1f3d; padding-bottom: 7px; margin-bottom: 10px; border-bottom: 1.5px solid #0f1f3d; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; }
        .box p { margin: 3px 0; color: #1a252f; font-size: 11.5px; }
        .box strong { color: #1a252f; font-weight: 600; }

        /* ── ITEMS TABLE ── */
        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        th { background: #0f1f3d; color: #fff; font-weight: 600; font-size: 11px; text-transform: uppercase; letter-spacing: 0.4px; padding: 9px 10px; text-align: left; print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        ...
        tbody tr:last-child { border-bottom: 2px solid #0f1f3d; }
        ...
        /* ── TOTALS ── */
        .totals { float: right; width: 310px; background: #0f1f3d; color: #fff; padding: 14px 18px; border-radius: 6px; print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        ...
        .notes-section > div { background: #f4f6fb; padding: 12px 14px; border-radius: 6px; margin-bottom: 10px; border-left: 3px solid #0f1f3d; }
        .notes-section strong { color: #0f1f3d; display: block; margin-bottom: 5px; font-size: 11.5px; font-weight: 700; }
