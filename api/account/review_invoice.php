...
try {
    ...
    // Phase C — block reviews against invoices on projects not in user scope
    ...
    $sigResult = workflowCaptureSignature($pdo, 'invoice', $invoice_id, 'reviewed',
    ...
    $response = ['success' => true, 'message' => 'Invoice marked as reviewed.'];
