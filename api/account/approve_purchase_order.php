...
if (!canApprove('purchase_orders')) {
    echo json_encode(['success' => false, 'message' => t('Access Denied: You do not have permission to approve purchase orders')]);
    exit;
}
...
try {
    ...
    $response = ['success' => true, 'message' => t('Purchase Order approved.')];
