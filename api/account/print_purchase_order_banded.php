...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── BLUE HEADER BAND ── */
        .blue-header { background: #1f7ae0; color: #fff; padding: 16px 22px; border-radius: 8px; margin: 20px 0 18px 0; display: flex; justify-content: space-between; align-items: center; print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        ...
        th { background: #1f7ae0; color: #fff; font-weight: 600; font-size: 11px; text-transform: uppercase; letter-spacing: 0.4px; padding: 9px 10px; text-align: left; print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        ...
        tbody tr:last-child { border-bottom: 2px solid #1f7ae0; }
        ...
        .totals-row.grand-total { border-top: 2px solid #1f7ae0; border-bottom: none; margin-top: 8px; padding-top: 10px; font-size: 14px; font-weight: 700; }
