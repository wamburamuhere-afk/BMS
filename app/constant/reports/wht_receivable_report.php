        ...
        <div class="card-body p-0"><div class="table-responsive">
            <table class="table table-hover align-middle mb-0 w-100" id="whtrTable">
                <thead class="table-light"><tr>
                    <th class="ps-3"><?= t('S/No') ?></th><th><?= t('Customer') ?></th><th><?= t('TIN') ?></th>
                    <th class="text-end"><?= t('Taxable Base') ?></th><th class="text-end"><?= t('WHT Credit') ?></th><th class="pe-3 text-end"><?= t('Payments') ?></th>
                </tr></thead>
                <tbody>
