...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $success_msg = t('Color settings updated successfully');
    } catch (Exception $e) {
        $error_msg = t('Error updating color settings:') . ' ' . $e->getMessage();
    }
}
?>
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0"><i class="bi bi-palette"></i> <?= t('Color Setting') ?></h2>
            <p class="text-muted"><?= t('Print template accents') ?></p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form method="POST">
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Sales Order Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Sales Order uses its own template family, visually distinct from Quotation even though both share the same data fields.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_so_confirmation" class="form-label"><?= t('Confirmation Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_so_ledger" class="form-label"><?= t('Ledger Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_so_studio" class="form-label"><?= t('Studio Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Quotation Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Quotation uses its own template family, visually distinct from Sales Order even though both share the same data fields.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_qt_noir" class="form-label"><?= t('Noir Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_qt_meadow" class="form-label"><?= t('Meadow Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_qt_terra" class="form-label"><?= t('Terra Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Invoice Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Invoice uses its own template family, separate from every other document.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_inv_summit" class="form-label"><?= t('Summit Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_inv_wave" class="form-label"><?= t('Wave Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_inv_onyx" class="form-label"><?= t('Onyx Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Delivery Note (Outbound) Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Outbound Delivery Note uses its own template family, separate from every other document.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_dn_depot" class="form-label"><?= t('Depot Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_dn_transit" class="form-label"><?= t('Transit Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_dn_custody" class="form-label"><?= t('Custody Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Credit Note Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Credit Note uses its own template family, separate from every other document.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_cn_ledger" class="form-label"><?= t('Ledger Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_cn_horizon" class="form-label"><?= t('Horizon Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_cn_ember" class="form-label"><?= t('Ember Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Sales Return Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Sales Return uses its own template family, separate from every other document.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_sr_intake" class="form-label"><?= t('Intake Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_sr_register" class="form-label"><?= t('Register Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_sr_meridian" class="form-label"><?= t('Meridian Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Purchase Order Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Purchase Order uses its own Navy/Corporate/Banded colors, separate from Purchase Return and Debit Note even though all three share the same layout designs.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_po_navy" class="form-label"><?= t('Navy Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_po_corporate" class="form-label"><?= t('Corporate Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_po_banded" class="form-label"><?= t('Banded Template') ?></label>
                        ...
                        <div class="form-text"><?= t('Only the blue is configurable here; the orange section bands stay fixed.') ?></div>
                    </div>
                </div>

                <!-- Purchase Return Print Template Colors (own family, unrelated to Purchase Order / Debit Note) -->
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Purchase Return Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Purchase Return uses its own Navy/Corporate/Banded colors, separate from Purchase Order and Debit Note even though all three share the same layout designs.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_pret_navy" class="form-label"><?= t('Navy Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_pret_corporate" class="form-label"><?= t('Corporate Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_pret_banded" class="form-label"><?= t('Banded Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Debit Note Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Debit Note uses its own Navy/Corporate/Banded colors, separate from Purchase Order and Purchase Return even though all three share the same layout designs.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_dbn_navy" class="form-label"><?= t('Navy Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_dbn_corporate" class="form-label"><?= t('Corporate Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_dbn_banded" class="form-label"><?= t('Banded Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('RFQ Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('RFQ uses its own letter-format template family, separate from the layouts above.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_rfq_striped" class="form-label"><?= t('Striped Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_rfq_minimal" class="form-label"><?= t('Minimal Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_rfq_radiant" class="form-label"><?= t('Radiant Template') ?></label>
                ...
                <div class="mb-3">
                    <h6 class="text-muted text-uppercase small fw-bold mt-3"><i class="bi bi-palette2 me-1"></i> <?= t('Delivery Order Print Template Colors') ?></h6>
                    <p class="text-muted small mb-2"><?= t('Delivery Order uses its own Manifest/Convoy/Waybill colors, separate from every other document.') ?></p>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        <label for="print_template_color_do_manifest" class="form-label"><?= t('Manifest Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_do_convoy" class="form-label"><?= t('Convoy Template') ?></label>
                    ...
                    <div class="col-md-4">
                        <label for="print_template_color_do_waybill" class="form-label"><?= t('Waybill Template') ?></label>
