...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    try {
        ...
        // Phase 3 – currency & Participation Fee (document purchase fee paid to participate)
                ...
                <form id="tenderWizardForm" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="card-body p-4 pt-3">
                        ...
                        <div class="wizard-phase d-none" id="phase-3">
                            <div class="col-12">
                                <h5 class="fw-bold text-primary mb-1"><i class="bi bi-ticket-perforated me-2"></i>Tender Participation Fee</h5>
                                ...
                                <div id="section_tzs" class="col-12">
                                    <div class="card border-0 rounded-3 overflow-hidden shadow-sm">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    <label class="form-label fw-bold">Participation Fee (Tshs) <span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                ...
                                <div id="section_usd" class="col-12 d-none">
                                    <div class="card border-0 rounded-3 overflow-hidden shadow-sm">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    <label class="form-label fw-bold">Participation Fee (USD) <span class="text-danger">*</span></label>
                                                    <div class="input-group">
