<?php
// File: app/bms/purchase/debit_notes/print_debit_note_banded.php
error_reporting(0);
...
// Debit Note's own Banded-layout accent color — separate from Purchase Order and
...
// tone).
$accent = getSetting('print_template_color_dbn_banded', '#1f7ae0');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body onload="window.print()">
    ...
    <div class="blue-header">
        ...
        <div class="meta">
            <p style="font-size:15px; font-weight:800;">DEBIT NOTE</p>
    ...
    <div class="two-col">
        <div class="band">
            <div class="band-title">Debit To</div>
        ...
        <div class="band">
            <div class="band-title">Status</div>
            <p><strong><?= strtoupper($dn['status']) ?></strong></p>
            <?php if (!empty($dn['return_number'])): ?><p>Ref Return: <?= htmlspecialchars($dn['return_number']) ?></p><?php endif; ?>
            <?php if (!empty($dn['warehouse_name'])): ?><p>Returned From: <?= htmlspecialchars($dn['warehouse_name']) ?></p><?php endif; ?>
        </div>
    </div>
    ...
    <div class="meta-strip">
        <div class="band">
            <div class="band-title">Prepared By</div>
            <p><?= htmlspecialchars($creator_name ?: 'System') ?></p>
        </div>
        <div class="band">
            <div class="band-title">Currency</div>
            <p><?= htmlspecialchars($currency) ?></p>
        </div>
        <div class="band">
            <div class="band-title">Reason</div>
            <p><?= !empty($dn['reason']) ? htmlspecialchars($dn['reason']) : '—' ?></p>
        </div>
    </div>
