                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer bg-white" style="padding: 6px 8px;">
                                <div style="display:flex; flex-wrap:nowrap; gap:4px;">
                                     ...
                                     <?php endif; ?>
                                     <a href="<?= getUrl('employee_details') ?>?id=<?= $employee['employee_id'] ?>#attendanceHistoryCard" class="btn btn-sm btn-outline-success" title="Attendance" style="flex:1; min-width:0; padding:3px 4px; font-size:0.72rem;">
