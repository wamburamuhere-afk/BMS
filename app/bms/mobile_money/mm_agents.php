...
includeHeader();
logActivity($pdo, $_SESSION['user_id'], 'View Agents / Outlets', 'Viewed Mobile Money Agents / Outlets');
?>
<div class="container-fluid py-4 px-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        <i class="bi bi-shop-window text-primary fs-4"></i>
        <h4 class="mb-0 fw-bold"><?= t('Agents / Outlets') ?></h4>
