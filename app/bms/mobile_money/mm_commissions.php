...
<div class="container-fluid py-4 px-4">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h4 class="mb-0 fw-bold"><?= t('Commissions') ?></h4>
        <span class="badge bg-primary ms-2"><?= t('Coming in Phase 5') ?></span>
    </div>
    <div class="alert alert-primary">
        <i class="bi bi-info-circle me-2"></i>
        <?= t('This section will be built in Phase 5 of the Mobile Money module.') ?>
    </div>
</div>
<?php includeFooter(); ?>
