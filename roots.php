...
$routes = [
    ...
    'print_received_invoice' => INVOICE_DIR . '/print_received_invoice.php',
    'print_received_invoice.php' => INVOICE_DIR . '/print_received_invoice.php',
    ...
    'invoice_print_summit' => INVOICE_DIR . '/invoice_print_summit.php',
    'invoice_print_summit.php' => INVOICE_DIR . '/invoice_print_summit.php',
    'invoice_print_wave' => INVOICE_DIR . '/invoice_print_wave.php',
    'invoice_print_wave.php' => INVOICE_DIR . '/invoice_print_wave.php',
    'invoice_print_onyx' => INVOICE_DIR . '/invoice_print_onyx.php',
    'invoice_print_onyx.php' => INVOICE_DIR . '/invoice_print_onyx.php',
    ...
    'print_sales_order_confirmation' => SALES_DIR . '/print_sales_order_confirmation.php',
    'print_sales_order_confirmation.php' => SALES_DIR . '/print_sales_order_confirmation.php',
    'print_sales_order_ledger' => SALES_DIR . '/print_sales_order_ledger.php',
    'print_sales_order_ledger.php' => SALES_DIR . '/print_sales_order_ledger.php',
    'print_sales_order_studio' => SALES_DIR . '/print_sales_order_studio.php',
    'print_sales_order_studio.php' => SALES_DIR . '/print_sales_order_studio.php',
    'print_quotation' => SALES_DIR . '/quotations/print_quotation.php',
    'print_quotation.php' => SALES_DIR . '/quotations/print_quotation.php',
    'print_quotation_noir' => SALES_DIR . '/quotations/print_quotation_noir.php',
    'print_quotation_noir.php' => SALES_DIR . '/quotations/print_quotation_noir.php',
    'print_quotation_meadow' => SALES_DIR . '/quotations/print_quotation_meadow.php',
    'print_quotation_meadow.php' => SALES_DIR . '/quotations/print_quotation_meadow.php',
    'print_quotation_terra' => SALES_DIR . '/quotations/print_quotation_terra.php',
    'print_quotation_terra.php' => SALES_DIR . '/quotations/print_quotation_terra.php',
    ...
    'print_delivery_note_depot' => API_DIR . '/account/print_delivery_note_depot.php',
    'print_delivery_note_depot.php' => API_DIR . '/account/print_delivery_note_depot.php',
    'print_delivery_note_transit' => API_DIR . '/account/print_delivery_note_transit.php',
    'print_delivery_note_transit.php' => API_DIR . '/account/print_delivery_note_transit.php',
    'print_delivery_note_custody' => API_DIR . '/account/print_delivery_note_custody.php',
    'print_delivery_note_custody.php' => API_DIR . '/account/print_delivery_note_custody.php',
    ...
    'print_delivery_order' => API_DIR . '/account/print_delivery_order.php',
    'print_delivery_order.php' => API_DIR . '/account/print_delivery_order.php',
    'print_delivery_order_manifest' => API_DIR . '/account/print_delivery_order_manifest.php',
    'print_delivery_order_manifest.php' => API_DIR . '/account/print_delivery_order_manifest.php',
    'print_delivery_order_convoy' => API_DIR . '/account/print_delivery_order_convoy.php',
    'print_delivery_order_convoy.php' => API_DIR . '/account/print_delivery_order_convoy.php',
    'print_delivery_order_waybill' => API_DIR . '/account/print_delivery_order_waybill.php',
    'print_delivery_order_waybill.php' => API_DIR . '/account/print_delivery_order_waybill.php',
    ...
    'print_rfq_navy' => API_DIR . '/account/print_rfq_navy.php',
    'print_rfq_navy.php' => API_DIR . '/account/print_rfq_navy.php',
    'print_rfq_corporate' => API_DIR . '/account/print_rfq_corporate.php',
    'print_rfq_corporate.php' => API_DIR . '/account/print_rfq_corporate.php',
    'print_rfq_banded' => API_DIR . '/account/print_rfq_banded.php',
    'print_rfq_banded.php' => API_DIR . '/account/print_rfq_banded.php',
    ...
    'print_sales_return_intake' => SALES_DIR . '/sales_returns/print_sales_return_intake.php',
    'print_sales_return_register' => SALES_DIR . '/sales_returns/print_sales_return_register.php',
    'print_sales_return_meridian' => SALES_DIR . '/sales_returns/print_sales_return_meridian.php',
    ...
    'print_debit_note_navy' => PURCHASE_DIR . '/debit_notes/print_debit_note_navy.php',
    'print_debit_note_corporate' => PURCHASE_DIR . '/debit_notes/print_debit_note_corporate.php',
    'print_debit_note_banded' => PURCHASE_DIR . '/debit_notes/print_debit_note_banded.php',
    'grn' => GRN_DIR . '/grn.php',
    ...
    'tender_boq' => TENDERS_DIR . '/tender_boq.php',
    'tender_boq.php' => TENDERS_DIR . '/tender_boq.php',
    'tender_materials' => TENDERS_DIR . '/tender_materials.php',
    'tender_materials.php' => TENDERS_DIR . '/tender_materials.php',
    'tender_checklist' => TENDERS_DIR . '/tender_checklist.php',
    'tender_checklist.php' => TENDERS_DIR . '/tender_checklist.php',
    'tender_form_of_tender' => TENDERS_DIR . '/tender_form_of_tender.php',
    'tender_form_of_tender.php' => TENDERS_DIR . '/tender_form_of_tender.php',
    'tender_print' => TENDERS_DIR . '/tender_print.php',
    'tender_print.php' => TENDERS_DIR . '/tender_print.php',
    ...
    'departments' => POS_DIR . '/departments.php',
    'departments.php' => POS_DIR . '/departments.php',
    'designations' => POS_DIR . '/designations.php',
    'designations.php' => POS_DIR . '/designations.php',
    'employment_types' => POS_DIR . '/employment_types.php',
    'employment_types.php' => POS_DIR . '/employment_types.php',
    'company_calendar' => POS_DIR . '/company_calendar.php',
    'company_calendar.php' => POS_DIR . '/company_calendar.php',
    'hr_dashboard' => POS_DIR . '/hr_dashboard.php',
    'hr_dashboard.php' => POS_DIR . '/hr_dashboard.php',
    ...
    'api/finalize_login' => API_DIR . '/finalize_login.php',
    'api/finalize_login.php' => API_DIR . '/finalize_login.php',
    ...
    'pos_user_sales_report' => REPORTS_DIR . '/pos_user_sales_report.php',
    'pos_profit_report' => REPORTS_DIR . '/pos_profit_report.php',
    ...
    'settings/zoom' => SETTINGS_DIR . '/zoom_settings.php',
    'zoom_settings' => SETTINGS_DIR . '/zoom_settings.php',
    'zoom_settings.php' => SETTINGS_DIR . '/zoom_settings.php',
    ...
    'available_modules' => SETTINGS_DIR . '/available_modules.php',
    'available_modules.php' => SETTINGS_DIR . '/available_modules.php',
    ...
    'pos_config_settings' => SETTINGS_DIR . '/pos_config_settings.php',
    'pos_config_settings.php' => SETTINGS_DIR . '/pos_config_settings.php',
    'color_settings' => SETTINGS_DIR . '/color_settings.php',
    'color_settings.php' => SETTINGS_DIR . '/color_settings.php',
